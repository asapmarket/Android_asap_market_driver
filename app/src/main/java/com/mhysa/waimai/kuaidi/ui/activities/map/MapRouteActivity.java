package com.mhysa.waimai.kuaidi.ui.activities.map;
...
public class MapRouteActivity extends BaseActivity implements OnMapReadyCallback,
    ...
    private boolean mHasRequestRoute = false;
    ...
    protected void getIntentData() {
        ...
        if (null != getIntent()) {
            mLat = getIntent().getStringExtra(INTENT_LAT);
            mLng = getIntent().getStringExtra(INTENT_LNG);
        }
    }
...
//                placeMarkerOnMap(currentLocation);
            ...
            public void onResult(@NonNull LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            status.startResolutionForResult(MapRouteActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void getRoutes() {
        ...
        if (StringUtils.getInstance().isNullOrEmpty(mLat)
                || StringUtils.getInstance().isNullOrEmpty(mLng)) {
            return;
        }

        String str_origin = "origin=" + mLastLocation.getLatitude() + ","
                + mLastLocation.getLongitude();

        String str_dest = "destination=" + mLat + "," + mLng;
        // Sensor enabled
    ...
    private class ParserTask extends
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.width(ExtendUtils.getInstance().dip2px(MapRouteActivity.this, 6));
    ...
    public static void invoke(Context context, String lat, String lng) {
        if (null == context) {
            return;
        }
