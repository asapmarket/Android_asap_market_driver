...
public class ErrandSearchSettingActivity extends BaseActivity {
    ...
    protected int getContentLayout() {
        return R.layout.activity_errand_search_setting_activity;
    }
    ...
    @OnClick({R.id.layout_back, R.id.tv_reset,
            ...
            R.id.tv_taken, R.id.tv_finished,
            R.id.tv_feedback, R.id.tv_onroad,
    })
    public void click(View view) {
        switch (view.getId()) {
            case R.id.layout_back: {
                ErrandSearchSettingActivity.this.finish();
                break;
            }
            ...
            case R.id.tv_taken: {
                ...
                mOrderStatusTv.setText(getResources().getString(R.string.order_status_taken1));
                break;
            }

            case R.id.tv_feedback: {
                // 已反馈
                mOrderStatus = FusionCode.OrderStatus.ORDER_STATUS_FEEDBACK;
                mOrderStatusTv.setText(getResources().getString(R.string.order_status_feedback));
                break;
            }
    ...
    private void search() {
        ...
        mRequest.user_id = Utils.getUserId(ErrandSearchSettingActivity.this);
        mRequest.token = Utils.getToken(ErrandSearchSettingActivity.this);
            ...
            mChooseWidget.setOnDateChangedListener(new OnDateChangedListener() {
                ...
                public void onDateChanged(Date date) {
                    ...
                    if (null != mCurrentEndDate && TimeUtils.getInstance().compareDate(date, mCurrentEndDate) > 0) {
                        PromptUtils.getInstance().showShortPromptToast(ErrandSearchSettingActivity.this, R.string.appointment_time_valid);
                        return;
                    }
    ...
    public static void invoke(Context context, OrderListRequest request, String tag) {
        Intent intent = new Intent(context, ErrandSearchSettingActivity.class);
